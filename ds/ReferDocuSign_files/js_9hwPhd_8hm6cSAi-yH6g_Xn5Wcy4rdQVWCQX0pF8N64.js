...
;
/**
 * @author Craig Tockman - for the system status form
 */
jQuery(document).ready(function(jQuery) {

//change default textarea text based on radio button clicks

//jQuery('#edit-body-und-0-format').hide();
      jQuery('#edit-field-status-level-und-service-available').click(function() {
       jQuery('#edit-body-en-0-value, #edit-body-und-0-value').val('DocuSign service is available and operating normally.');
   })
   jQuery('#edit-field-status-level-und-service-degradation').click(function() {
       jQuery('#edit-body-en-0-value, #edit-body-und-0-value').val('The DocuSign Technical Operations team is looking into a service degradation. During this period, customers may experience delays while accessing DocuSign. Thank you for your patience. We apologize for any inconvenience this may cause.');
   })
   jQuery('#edit-field-status-level-und-service-disruption').click(function() {
       jQuery('#edit-body-en-0-value, #edit-body-und-0-value').val('The DocuSign Technical Operations Team is investigating a service disruption. Thank you for your patience. We apologize for any inconvenience this may cause.');
   })
});
